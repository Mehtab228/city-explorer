...
- Same as before but this time we cleaned up the code, added modules on the backend and on the front end added components which render everything to help clean up the code and have one thing responsible for rendering one thing

## Change Log5

- added modules on backend

- added some components and styling on front end

## Credit and Collaborations5

Name of feature: Organize
